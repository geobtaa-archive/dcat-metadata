...
ActionDate = '20190107'
PreviousActionDate = '20190104-reset'

## names of the main directory containing folders named "Jsons" and "Reports"
directory = '/Users/majew030/GitHUB/dcat-metadata'
inputCsv = '/Users/majew030/GitHUB/dcat-metadata/arcPortals.csv'
...
def printReport (report_type, dictionary, fields):
    report = directory + "/Reports/%s_%s_%s.csv" % (portalName, ActionDate, report_type)
