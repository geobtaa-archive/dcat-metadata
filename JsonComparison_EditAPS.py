...
PreviousActionDate = '20180508'
ActionDate = '20180702'

## names of the main directory containing folders named "Jsons" and "Reports"
directory = r'C:\Work\ORGANIZATION\Monthly_Resource_Auditing\ArcGIS_Portals\ScriptRun'

##list of metadata fields at the first level
...
with open(directory + '\All_ArcPortals.csv') as f:
